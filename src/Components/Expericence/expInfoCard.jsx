...
return (
    ...
    <div className="w-[85%] h-full  flex flex-col justify-center">
            ...
            <p className="text-[#eaeaea] font-poppins font-medium md:font-semibold text-xl md:text-2xl">{role}</p>
            <p className="text-[#eaeaea] opacity-80 font-poppins font-medium md:font-semibold text-[17px] md:text-[1.3rem]">{organization}</p>
    </div>
