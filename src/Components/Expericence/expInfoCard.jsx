...
return (
    ...
    <div ref={ref}  className={`w-[680px] hover:bg-[rgb(245,101,57,0.73)] cursor-pointer bg-[rgba(245,101,57,0.5)]  h-[140px]  rounded-3xl flex ${isView? style.visible: style.invisible} `}>
