                ...
                <div className="flex w-[90%] flex-col-reverse md:flex-row h-full mx-auto box-border  mt-7">
                       ...
                       ${isView?"opacity-100 translate-x-0": "opacity-0 -translate-x-full"}
                        `}  style={{transitionDuration:"1500ms" }}>
                         <p className="text-[#f56539] text-[2.5rem] text-center md:text-start md:text-5xl lg:text-6xl font-bold">Who I Am</p>
                       ...
                       <div className=" mb-8 md:mb-0  bg-transparent w-full h-[330px] items-start justify-center md:w-[65%] md:h-[408px] flex md:items-center md:justify-end  ">
